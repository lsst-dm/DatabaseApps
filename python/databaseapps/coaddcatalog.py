...
class CoaddCatalog:
    ...
    def __init__(self, ingesttype, datafile, schema):
    ...
    def writeControlfileHeader(self,controlfile):
        ...
        # force database-generated ID to be included, and at the beginning of cols
            ...
            while endrow < lastrow:
                ...
                for row in data:
                    ...
                    for idx in range(0,len(orderedFitsColumns)):
                        # insert database-generated ID at the beginning of the list
